...
class TestText:
    ...
    def test_read_text(self, text_file):
        ...
        text_stream = Text(
            name="test",
            reader_params=TextParams(path=text_file)
        )
    ...
    def test_custom_encoding(self, temp_dir):
        ...
        text_stream = Text(
            name="test",
            reader_params=TextParams(path=file_path, encoding="utf-16")
        )
    ...
    def test_nonexistent_file(self, temp_dir):
        ...
        text_stream = Text(
            name="test",
            reader_params=TextParams(path=nonexistent_path)
        )
    ...
    def test_empty_file(self, temp_dir):
        ...
        text_stream = Text(
            name="test",
            reader_params=TextParams(path=file_path)
        )
