                        ...
                        data_streams=[
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/ActivePatch.json"
                                ),
                            ),
                            SoftwareEvents(
                                name="ActiveSite",
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/ActiveSite.json"
                                ),
                            ),
                            SoftwareEvents(
                                name="ArmOdor",
                                description="An event sent each time an Odor mixture messaged is sent to arm at the olfactometer.",
                                reader_params=SoftwareEvents.make_params(dataset_root / "SoftwareEvents/ArmOdor.json"),
                            ),
                            SoftwareEvents(
                                name="Block",
                                description="An event signaling block transitions.",
                                reader_params=SoftwareEvents.make_params(dataset_root / "SoftwareEvents/Block.json"),
                            ),
                            SoftwareEvents(
                                name="ChoiceFeedback",
                                description="A unit event that is emitted when the subject receives feedback about their choice.",
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/ChoiceFeedback.json"
                                ),
                            ),
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/DepletionVariable.json"
                                ),
                            ),
                            SoftwareEvents(
                                name="GiveReward",
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/GiveReward.json"
                                ),
                            ),
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/PatchRewardAmount.json"
                                ),
                            ),
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/PatchRewardAvailable.json"
                                ),
                            ),
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/PatchRewardProbability.json"
                                ),
                            ),
                            SoftwareEvents(
                                name="RngSeed",
                                description="The value of the random number generator seed.",
                                reader_params=SoftwareEvents.make_params(dataset_root / "SoftwareEvents/RngSeed.json"),
                            ),
                            SoftwareEvents(
                                name="StopVelocityThreshold",
                                description="The velocity threshold used to determine if the subject is stopped or not. In cm/s.",
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/StopVelocityTreshold.json"
                                ),
                            ),
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/VisualCorridorSpecs.json"
                                ),
                            ),
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/WaitRewardOutcome.json"
                                ),
                            ),
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/WaitLickOutcome.json"
                                ),
                            ),
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/UpdaterStopDurationOffset.json"
                                ),
                            ),
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/UpdaterStopVelocityThreshold.json"
                                ),
                            ),
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/UpdaterRewardDelayOffset.json"
                                ),
                            ),
                            SoftwareEvents(
                                ...
                                reader_params=SoftwareEvents.make_params(
                                    dataset_root / "SoftwareEvents/HabituationRewardAvailable.json"
                                ),
                            ),
                        ],
                    ),
